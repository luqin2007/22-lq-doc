...
- date：获取当前时间
- [[../../../../工具/Linux/bash/网络相关#ifconfig|ifconfig]]：用于获取 IP 地址
- who：当前登录的用户名
- [[../../../../工具/Linux/bash/系统管理#ps|ps]]：进程列表
- [[../../../../工具/Linux/bash/系统管理#df|df]]：获取分区信息
...
- `<模式>`：模式匹配，支持正则、POSIX 标准字符类
	- 通过 [[../../../../工具/Linux/bash/set shopt tput#shopt|shopt]] 开启 `extglob` 后可支持[[扩展通配符]]
- `<命令序列>`：每个分支执行的脚本
