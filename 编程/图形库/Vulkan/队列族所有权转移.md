...
```cpp
void CommandBuffer::transferImageOwnership(uint32_t srcQueueFamilyIndex, uint32_t dstQueueFamilyIndex) {
        VkImageMemoryBarrier barrier = {
                ...
                .image = Swapchain::base().getCurrentImage(),
                .subresourceRange = { VK_IMAGE_ASPECT_COLOR_BIT, 0, 1, 0, 1 }
        };
        vkCmdPipelineBarrier(handle, VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT, VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT, 0, 0, nullptr, 0, nullptr, 1, &barrier);
    }
```